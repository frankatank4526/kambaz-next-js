...
export default function PeopleDetails({ uid, onClose }: { uid: string | null; onClose: () => void; }) {
    ...
    return (
        <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
            ...
            <div className="text-danger fs-4 wd-name"> {!editingEmail && (
                ...
                {!editingEmail && (
                    <div className="wd-name"
                        ...
                        {user.email}</div>)}
                {user && editingEmail && (
                    <FormControl type="email" className="w-50 wd-edit-name"
            ...
            <br />
            <select value={role} onChange={async (e) => {
                // had to do this here instead of calling saveUser since setRole wasn't saving state fast enough. 
