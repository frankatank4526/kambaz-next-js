 ...
 return (
   <div id="wd-course-status" style={{ width: "350px" }}>
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       ...
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <CgLoadbarSound className="me-2 fs-1"style={{margin:"-10px"}} /> View Course Screen </Button>

        <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <BsMegaphone className="me-2 fs-5" /> New Announcement </Button>

       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <CgLoadbarSound className="me-2 fs-1" style={{margin:"-10px"}}/> New Analytics </Button>
