    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                introduce topics such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags
                can be used to format plain text so that it renders in a browser as large headings.
            ...
            <div id="wd-lists">
                ...
                <p>Simple Egg Fried Rice</p>
                <ol id="wd-your-favorite-recipe">
                    <li> Whisk 2-3 eggs</li>
                    <li> Mix 1 tablespoon fish sauce into eggs</li>
                    <li> Oil frying pan/wok with vegtable oil, heat on medium-medium high, add eggs</li>
                    <li> Immediately add 2 servings of cooked rice</li>
                    <li> Stir, adding in salt and pepper</li>
                    <li> Keep frying till desired doneness, taste and add more salt/pepper as needed</li>
                </ol>
            ...
            <div id="wd-navigation">
                <h4>Anchor tag</h4>
                Please
                <a style={{ paddingLeft: '4px', paddingRight: '4px' }} href="https://www.lipsum.com" id="wd-lipsum">click here</a>
